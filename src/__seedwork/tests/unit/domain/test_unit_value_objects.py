...
class TestValueObjectUnit(unittest.TestCase):
    ...
    def test_if_is_a_abastract_class(self):
        self.assertIsInstance(ValueObject(), ABC)

    def test_init_prop(self):
        vo1 = StubOneProp(prop='value')
        self.assertTrue(vo1.prop, 'value')

        vo2 = StubTwoProp(prop1='value1', prop2='value2')
        self.assertTrue(vo2.prop1, 'value1')
        self.assertTrue(vo2.prop2, 'value2')
    ...
    def test_accept_uuid_passed_in_contructor(self):
        with patch.object(
            ...
            value_object = UniqueEntityId(
                'df141806-a254-4197-bed3-f0bb3b67b227')
            mock_validate.assert_called_once()
            self.assertEqual(
                value_object.id, 'df141806-a254-4197-bed3-f0bb3b67b227')
